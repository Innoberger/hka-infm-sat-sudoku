 ...
 */
list<indices_set> field_indices(size_t& order) {
    ...
    for (size_t i = 0; i < dimension; i++) {
        ...
        for (size_t j = 0; j < dimension; j++) {
            ...
            for (size_t n = 1; n <= dimension; n++) {
                field_indices.push_back(encode(n, i, j, order));
            }
 ...
 */
list<indices_set> col_indices(size_t& order) {
    list<indices_set> indices;
    size_t dimension = order * order;
    ...
    for (size_t n = 1; n <= dimension; n++) {
        ...
        for (size_t i = 0; i < dimension; i++) {
            ...
            // iterate over each row
            for (size_t j = 0; j < dimension; j++) {
                column_indices.push_back(encode(n, i, j, order));
            }
 ...
 */
list<indices_set> row_indices(size_t& order) {
    list<indices_set> indices;
    size_t dimension = order * order;
    ...
    for (size_t n = 1; n <= dimension; n++) {
        ...
        for (size_t j = 0; j < dimension; j++) {
            ...
            // iterate over each column
            for (size_t i = 0; i < dimension; i++) {
                row_indices.push_back(encode(n, i, j, order));
            }
 ...
 */
list<indices_set> block_indices(size_t& order) {
    list<indices_set> indices;
    size_t dimension = order * order;
            ...
            for (size_t b = 0; b < order; b++) {
                ...
                for (size_t col_i = 0; col_i < order; col_i++) {
                    ...
                    for (size_t row_j = 0; row_j < order; row_j++) {
                        ...
                        block_indices.push_back(encode(n, col_i + col_offset, row_j + row_offset, order));
                    }
                }
